...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(Modifier.isStatic(modifiersOfThisClass));*/
    ...
    public static boolean isAllModifiersContainSpecificModifier(int allModifiers, int specificModifier) {
        if(Modifier.isStatic(specificModifier)&& Modifier.isStatic(allModifiers))return true;
        if(Modifier.isPublic(specificModifier)&& Modifier.isPublic(allModifiers))return true;
        return false;
    }
