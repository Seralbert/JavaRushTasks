...
V 1. Класс Solution должен содержать класс LineItem.
V 2. Класс Solution должен содержать enum Type.
V 3. Класс Solution должен содержать публичное статическое поле lines типа List, которое сразу проинициализировано.
